...
namespace Demo.Security
{
    ...
    {
        public const string RolesClaimType = "http://www.example.com/CuttingEdge.Security.Role";
        public const string GroupClaimType = "http://www.example.com/CuttingEdge.Security.Group";
        public const string IPClaimType = "http://www.example.com/CuttingEdge.Security.IP";
        public const string IdClaimType = "http://www.example.com/CuttingEdge.Security.Id";
